...
Templates are text files in ~/.dreamland/templates/ with {{variable}} placeholders.
Built-in templates ship with Dreamland. User templates override built-ins.
...
log = logging.getLogger("dreamland.templates")

TEMPLATES_DIR = DREAMLAND_HOME / "templates"

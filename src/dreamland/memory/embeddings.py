...
If you need a different model, set the ``DREAMLAND_EMBED_MODEL`` env var
...
log = logging.getLogger("dreamland.memory.embeddings")

DEFAULT_MODEL = os.environ.get(
    "DREAMLAND_EMBED_MODEL", "sentence-transformers/all-MiniLM-L6-v2"
)

...
Snippets are stored in ~/.dreamland/snippets.json and persist across sessions.
...
log = logging.getLogger("dreamland.cli.snippets")

SNIPPETS_FILE = DREAMLAND_HOME / "snippets.json"

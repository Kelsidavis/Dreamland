...
Aliases are stored in ~/.dreamland/aliases.json and persist across sessions.
...
log = logging.getLogger("dreamland.cli.aliases")

ALIASES_FILE = DREAMLAND_HOME / "aliases.json"

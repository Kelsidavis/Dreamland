"""Dreamland MCP server — exposes the memory store to MCP clients.
...
that Dreamland's own agent runtime uses. No extra dependency — the
...
from dreamland.mcp.server import MemoryMCPServer, serve_stdio

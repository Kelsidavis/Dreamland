...
log = logging.getLogger("dreamland.skills.claude")
...
def _get_client() -> Any:
    ...
    from dreamland.agent.claude_runtime import _read_oauth_token
...
class ClaudeSkill(Skill):
    ...
    def _resolve_model(alias: str) -> str:
        from dreamland.agent.claude_runtime import MODEL_ALIASES

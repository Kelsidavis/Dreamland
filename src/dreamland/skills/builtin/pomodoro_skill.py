...
class PomodoroSkill(Skill):
    ...
    def description(self) -> str:
        return "Pomodoro focus timer — work/break cycles"
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        "minutes": {
                            "type": "integer",
                            "description": "Work duration (default: 25)",
                        },

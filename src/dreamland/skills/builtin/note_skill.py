...
class NoteSkill(Skill):
    ...
    def description(self) -> str:
        return "Session scratchpad — quick notes that last until restart"

    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                name="note_set",
                description="Save a quick note (session-only, not persisted)",
                parameters={
                    "type": "object",
                    "properties": {
            ...
            ToolDefinition(
                name="note_list",
                description="List all session notes",
                parameters={"type": "object", "properties": {}},
            ),
            ToolDefinition(
                name="note_clear",
                description="Clear all session notes",
                parameters={"type": "object", "properties": {}},
            ),
        ]

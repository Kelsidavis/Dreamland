...
class CheatSkill(Skill):
    ...
    def description(self) -> str:
        return "Quick cheat sheets via cheat.sh"

    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                name="cheat_sheet",
                description="Get a cheat sheet for a command or topic",
                parameters={
                    "type": "object",
                    "properties": {
                        "topic": {
                            "type": "string",
                            "description": "Command or topic (e.g., curl, python/list, tar)",
                        }
                    },
                    "required": ["topic"],
                },

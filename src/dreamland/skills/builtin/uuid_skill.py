...
class UuidSkill(Skill):
    ...
    def description(self) -> str:
        return "Generate UUIDs, random strings, passwords, and test data"
    ...
    def tools(self) -> list[ToolDefinition]:
        return [
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "no_symbols": {
                            "type": "boolean",
                            "description": "Alphanumeric only (default: false)",
                        },
                    },
                },
            ),
            ToolDefinition(
                name="generate_token",
                description="Generate a random hex or base64 token",
                parameters={
                    "type": "object",
                    "properties": {
                        "bytes": {
                        ...
                        "encoding": {
                            "type": "string",
                            "enum": ["hex", "base64", "urlsafe"],
                            "description": "Encoding (default: hex)",
                        },
                    },
                },
            ),
    ...
    async def execute(self, tool_name: str, arguments: dict[str, Any]) -> Any:
        match tool_name:
            case "generate_uuid":
                return self._uuid(arguments.get("count", 1), arguments.get("format", "standard"))
            case "generate_password":
                return self._password(
                    arguments.get("length", 24), arguments.get("no_symbols", False)
                )
            case "generate_token":
                return self._token(arguments.get("bytes", 32), arguments.get("encoding", "hex"))
            case _:

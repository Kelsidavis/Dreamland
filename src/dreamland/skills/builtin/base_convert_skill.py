...
class BaseConvertSkill(Skill):
    ...
    def description(self) -> str:
        return "Convert numbers between bases (binary, octal, decimal, hex)"
    ...
    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        "number": {
                            "type": "string",
                            "description": "Number to convert (e.g., 0xFF, 0b1010, 42)",
                        },
            ...
            ToolDefinition(
                name="show_all_bases",
                description="Show a number in all common bases",
                parameters={
                    "type": "object",

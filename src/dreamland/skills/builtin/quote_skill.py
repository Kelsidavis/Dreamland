...
_QUOTES = [
    ("It doesn't exist.", "Douglas Adams"),
    ...
    (
        "A dreamland is about the most massively useful thing an interstellar hitchhiker can have.",
        "Douglas Adams",
    ),
...
class QuoteSkill(Skill):
    ...
    def description(self) -> str:
        return "Random inspirational and programming quotes"

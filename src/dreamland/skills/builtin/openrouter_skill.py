...
class OpenRouterSkill(Skill):
    ...
    def description(self) -> str:
        return "Browse AI models on OpenRouter — pricing and capabilities"

    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                name="or_models",
                description="List available models on OpenRouter with pricing",
                parameters={
                    "type": "object",
                    "properties": {

...
class GitignoreSkill(Skill):
    ...
    def description(self) -> str:
        return "Generate and manage .gitignore files"

    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(
                name="gitignore_generate",
                description="Generate a .gitignore for a language/framework",
                parameters={
                    "type": "object",
                    "properties": {
                        "languages": {
                        ...
                        "extras": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "Extra patterns to add",
                        },
                    },
                    "required": ["languages"],
                },
            ...
            ToolDefinition(
                ...
                description="Check which files would be ignored by current .gitignore",
                parameters={
                    "type": "object",
                    "properties": {
                        "path": {
    ...
    async def execute(self, tool_name: str, arguments: dict[str, Any]) -> Any:
        match tool_name:
            case "gitignore_generate":
                return self._generate(arguments["languages"], arguments.get("extras", []))
            case "gitignore_check":
                return self._check(arguments.get("path", "."))
            case _:

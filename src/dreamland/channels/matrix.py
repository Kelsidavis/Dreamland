"""Matrix bot channel — run Dreamland on the Matrix protocol.
...
Setup:
  ...
  3. Run: dreamland matrix --homeserver https://matrix.org --token YOUR_TOKEN
"""
...
log = logging.getLogger("dreamland.channels.matrix")

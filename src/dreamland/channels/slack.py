"""Slack bot channel — run Dreamland as a Slack app using Socket Mode.
...
Setup:
  ...
  5. Run: dreamland slack --bot-token xoxb-... --app-token xapp-...
"""
...
log = logging.getLogger("dreamland.channels.slack")

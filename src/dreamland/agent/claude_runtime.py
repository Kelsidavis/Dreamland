...
from dreamland.agent.tools_payload import tools_as_anthropic
from dreamland.config import DreamlandConfig
from dreamland.skills.registry import SkillRegistry

log = logging.getLogger("dreamland.agent.claude")
...
class ClaudeCodeRuntime:
    ...
    Usage:
        dreamland chat --backend claude                  # Sonnet (default)
        dreamland chat --backend claude --claude-model opus
    """
    ...
    def _build_system_prompt(
        ...
        """Build system prompt with dreamland's identity, context, and tool instructions.
    ...
    def _build_messages(self, conversation: Conversation) -> list[dict[str, str]]:
        """Convert dreamland conversation to Anthropic messages format."""
        existing_messages = [

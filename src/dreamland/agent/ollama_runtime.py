...
log = logging.getLogger("dreamland.agent.ollama")
...
class OllamaRuntime:
    ...
    Usage:
        dreamland worker --master ws://... --backend ollama
        dreamland worker --master ws://... --backend ollama --ollama-url http://gpu-box:11434
    """

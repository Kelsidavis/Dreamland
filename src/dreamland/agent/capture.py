...
log = logging.getLogger("dreamland.agent.capture")
...
def run_capture_hooks(
    ...
    *,
    ...
    if getattr(config, "auto_capture", True):
        try:
            from dreamland.memory.auto_capture import apply as _ac_apply
    ...
    try:
        ...
        from dreamland.memory.llm_extract import schedule_background_extraction

"""Cross-process runtime lock to prevent multiple Dreamland instances."""
...
_LOCK_PATH = DREAMLAND_HOME / "runtime.lock"
_LOCK_HELD = False
        ...
        try:
            ...
            if owner_pid is None or not _pid_is_running(owner_pid):
                try:
                    ...
                    raise RuntimeError(
                        "Another Dreamland instance appears to be starting. "
            ...
            raise RuntimeError(
                f"Dreamland is already running in another process (PID {owner_pid}). "

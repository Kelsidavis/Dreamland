...
Persists schedules to ~/.dreamland/schedules.json so they survive restarts.
...
log = logging.getLogger("dreamland.agent.scheduling")

SCHEDULES_FILE = DREAMLAND_HOME / "schedules.json"
...
def _load_schedules() -> list[Schedule]:
    ...
    try:
        ...
        try:
            ...
            import logging
            logging.getLogger("dreamland.scheduling").warning(
